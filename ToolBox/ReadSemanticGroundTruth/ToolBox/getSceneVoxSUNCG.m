...
voxOriginWorld    = extCam2World(1:3,1:3)*voxOriginCam + extCam2World(1:3,4) - ...
                    [voxSize(1)/2*voxUnit ; voxSize(2)/2*voxUnit ; voxSize(3)/2*voxUnit];
...
for objId = roomStruct.nodeIndices
    ...
    if isfield(object_struct, 'modelId')
        ...
        filename= fullfile(pathToData,'object_vox/object_vox_data/',...
